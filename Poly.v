...
Theorem app_assoc : forall A (l m n:list A),
  l ++ m ++ n = (l ++ m) ++ n.
Proof.
  intros X l m n. induction l as [|x l'].
  - simpl. reflexivity.
  - simpl. rewrite IHl'. reflexivity.
Qed.
...
Proof.
  intros X l1 l2. induction l1 as [|x l'].
  - simpl. reflexivity.
  - simpl. rewrite IHl'. reflexivity.
Qed.
(** [] *)
...
Proof. intros X Y f l1 l2. induction l1 as [|e l'].
  - simpl. reflexivity.
  - simpl. rewrite IHl'. reflexivity.
Qed.
...
Proof.
  intros X Y f l. induction l as [|e l'].
  - simpl. reflexivity.
...
Proof. intros X Y f l. induction l as [|e l'].
  - reflexivity.
  - simpl. rewrite <- IHl'. reflexivity.
Qed.
...
*)
(*  Basis: n = 0
    length l = 0 => l is empty => None
    IH: length l = n' => nth_error X l n' = None
      l = [] => None
      l = h :: t => nth_error X t (pred n) => IH => None. *)

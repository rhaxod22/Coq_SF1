...
Theorem andb_eq_orb :
  ...
  b = c.
Proof.
  destruct b; destruct c; simpl; intros; destruct H; try reflexivity.
Qed.
...
Proof.
  intros; induction lst1; try destruct x; simpl; try rewrite IHlst1; reflexivity.
Qed.
(** [] *)
...
Proof.
  intros b c d; destructpf d; destructpf c; destructpf b.
Qed.
(** [] *)
